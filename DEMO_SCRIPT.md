...
- Telegram Desktop/App — visible for notification demo
...
7. **Show Telegram notification** on phone/desktop: *"And simultaneously, the team received this critical alert on Telegram."*
...
6. **Show Telegram** — resolution notification with AI summary received ✅
...
| No Telegram notification | Check `.env` for correct token and chat ID |
...
- Telegram chat receiving **New Ticket** notification (🎫)
- Telegram chat receiving **Critical Escalation** notification (🚨)
- Telegram chat receiving **Resolved** notification (✅)

These three notifications demonstrate the complete integration lifecycle.
